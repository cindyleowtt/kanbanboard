...
class Flasks(db.Model):
	...
	# db.Column('username', db.String(15), db.ForeignKey('users.username'), nullable=False)
	#user = db.relationship('Users', backref=) 
...
@app.route('/f', methods= ['PUT'])
def update_task(task_id):
	pass # Need to update here 
